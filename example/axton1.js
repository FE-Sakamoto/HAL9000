...
function getReturn(firstCall) {
    ...
    if (rest["content"] !== undefined) {
        ...
        if (rest["content"] === '--CATMODE--') {
            ...
            $('.content').html($('.content').html() + prefix + 'Leave me a message, tap Enter to send. The first word separated by space will be saved as your nick name.<br>');
            $('.prefix,.preblank').hide();
            $('.preleave').show();
            lmMode = 1
        } else {
